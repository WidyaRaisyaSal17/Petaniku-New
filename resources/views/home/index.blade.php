...
@section('content')
    ...
    <section class="hero-wrap text-center relative">
        <div id="owl-hero" class="owl-carousel owl-theme light-arrows slider-animated">
            ...
            <div class="hero-slide overlay" style="background-image:url(/uploads/sliders/{{$slider->gambar}})">
                <div class="container">
                            ...
                            <div class="hover-overlay">
                                ...
                                <div class="product-details valign">
                                    ...
                                    <h3 class="product-title">
                                        <a href="/product/{{$product->id_produk}}">{{$product->nama_produk}}</a>
                                    </h3>
                                    <span class="price">
                                        <ins>
                                    ...
                                    <div class="btn-quickview">
                                        <a href="/product/{{$product->id_produk}}" class="btn btn-md btn-color">
                                            <span>More</span>
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="section-wrap relative testimonials bg-parallax overlay"
        style="background-image:url(img/testimonials/testimonial_bg.jpg);">
