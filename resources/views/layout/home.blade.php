                                ...
                                <div class="logo-container">
                                    <div class="logo-wrap">
                                        <a href="/">
                                            ...
                                            @endphp
                                            <span class="logo-text">Petani<span class="bold-italic">Ku.</span></span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-cart mobile-cart hidden-lg hidden-md">
                                    <div class="nav-cart-outer">
                                        <div class="nav-cart-inner">
                                            <a href="/frontend/#" class="nav-cart-icon">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <div class="col-md-3 megamenu-item">
                                                                    <ul class="menu-list">
                                                                        <li>
                                                                            <a
                                                                                href="/products/{{ $category->id_kategori }}">{{ $category->nama_kategori }}</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    ...
                                    <p class="mb-30">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos
                                        cupiditate obcaecati dicta? Beatae sit quod atque veniam dignissimos impedit
                                        fuga cupiditate quibusdam alias, asperiores corrupti eveniet dolorem, voluptatum
                                        nihil eligendi!</p>
                                    <div class="footer-socials">
                                        <div class="social-icons nobase">
                                            <a href="/frontend/#"><i class="fa fa-twitter"></i></a>
                                            <a href="/frontend/#"><i class="fa fa-facebook"></i></a>
                                            <a href="/frontend/#"><i class="fa fa-google-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end about us -->
